...
const repo_gh = "1122bot/bilalbot";
const nama_file = "wtf.json";
const path_ghp = "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";
...
.row()
.url("📢Trelegram Channel", "https://t.me/mzazitechinc")
.row()
.url("▶️YouTube Channel", "comming soon");

      return await ctx.replyWithPhoto(imageMenu, {
        caption: `
Hello, ${ctx.from.first_name} 👋
To unlock all features of this bot, you must complete the required verification steps first.
...
❗ Important:
Access is strictly limited to verified users only.
If you do not complete all steps, the bot will remain unavailable to you.
...
bot.on("message", async (ctx) => {
  try {
    ...
    if (!hasAccess(userId)) {
    return ctx.reply("🔒 *Free Mode nonaktifkan*\nOnly premium users owner reseller can use the bot If you want to buy premium DM dev @LG_BAHIRAVA");
  }
    switch (command) {
      case "start": {
        const username = ctx.from.username
...
<b><i>{❓} venom bot bug say hello ${username}</i></b>

<b>「 𝐁𝐀𝐇𝐈𝐑𝐀𝐕𝐀 𝐁𝐔𝐆 𝐁𝐎𝐓 ☇ 𝐂𝐨𝐫𝐞˚𝐒𝐲𝐬𝐭𝐞𝐦📟  」</b>
⬡ Dev: @LG_BAHIRAVA 
⬡ Run Time: ${uptime}
⬡ Memory: ${usedMemory}
...
<b>📞 Support</b>
Contact @LG_BAHIRAVA for assistance
</blockquote>`.trim();
  ...
  .url("CHANNEL", `https://t.me/${CHANNEL_ID.replace("@", "")}`);
    ...
    try {
        ...
        if (cooldownCheck.onCooldown) {
            return ctx.reply(
                `⏳ *Cooldown Aktif*\n\nSilakan tunggu ${cooldownCheck.remaining} menit sebelum menggunakan /legened-pending lagi.`,
                { parse_mode: "Markdown" }
            );
        }
        ...
        if (!input) {
            return ctx.reply(
                ...
                "Gunakan format:\n" +
                "<code>/legened-pending 628xxxxxxx</code>\n\n" +
                "<i>Contoh:</i> <code>/legened-pending 628123456789</code>",
                { parse_mode: "HTML" }
            );
        }
        ...
        await ctx.replyWithPhoto(imageMenu, {
            caption:
                "<b>「  𝐁𝐀𝐇𝐈𝐑𝐀𝐕𝐀 𝐁𝐔𝐆 𝐁𝐎𝐓 ☇ 𝐁𝐮𝐠˚𝐒𝐲𝐬𝐭𝐞𝐦🦠  」</b>\n" +
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        {
                            text: "👀 ćhannal",
                            url: "https://t.me/BAHIRAVA_CHANNEL2",
                        },
                        {
                            text: "👤 owner ",
                            url: "https://t.me/LG_BAHIRAVA",
                        },
                    ],
                ],
            },
    ...
    try {
        ...
        if (cooldownCheck.onCooldown) {
            return ctx.reply(
                `⏳ *Cooldown Aktif*\n\nSilakan tunggu ${cooldownCheck.remaining} menit sebelum menggunakan /legened-buldozer lagi.`,
                { parse_mode: "Markdown" }
            );
        }
        ...
        if (!input) {
            return ctx.reply(
                "<b>⚠️ Format Yang Benar</b>\n" +
                "Gunakan format:\n" +
                "<code>/legened-buldozer 628xxxxxxx</code>\n\n" +
                "<i>Contoh:</i> <code>/legened-buldozer 628123456789</code>",
                { parse_mode: "HTML" }
            );
        }
...
bot.callbackQuery("open_allaccess", async (ctx) => {
  try {
    ...
    const caption = `
<blockquote>
<b><i>{❓} BAHIRAVA say hello ${userDisplay}</i></b>
...
- legened-ui number
ᚖ example : /legened-ui 628xxx

force close andro invisible
bug not work for beta
- legened-andro number
ᚖ example : /legened-andro 628xxx

force close 1 msg work beta
- legened-fcbeta number
ᚖ example : /legened-fcbeta 628xxx

iphone crash
- legened-ios number
ᚖ example : /legened-ios 628xxx
...
android delayed
- legened-delay number
ᚖ example : /legened-delay 628xxx

android delay beta
- legened-beta number
ᚖ example : /legened-beta 628xxx

android suck up quota 
- legened-buldozer number
ᚖ example : /legened-buldozer 628xxx

android stuck message
- legened-pending number
ᚖ example : /legened-pending 628xxx
...
bot.callbackQuery("back_to_main", async (ctx) => {
  try {
    ...
    const caption = `<blockquote>
<b><i>{❓} BAHIRAVA say hello ${username}</i></b>
